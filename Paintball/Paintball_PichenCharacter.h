...
#include "Paintball_PichenCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class APaintball_PichenCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class APaintball_PichenProjectile> ProjectileClass;
